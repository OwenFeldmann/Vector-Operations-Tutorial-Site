...
function clickCanvas(event)
{
	...
	if(points[points.length-1] != null){
		...
		canvasContext.beginPath();
			...
			canvasContext.lineTo(canvasWidth/2 + vK[x], canvasHeight/2 - vK[y]);
			canvasContext.stroke();
		canvasContext.closePath();

		canvasContext.fillStyle = 'rgb(255,55,0)';//orange
		canvasContext.font = '15px Arial';
		canvasContext.fillText("vK", canvasWidth/2 + vK[x] + pointSize, canvasHeight/2 - vK[y] + pointSize);

		canvasContext.fillRect(canvasWidth/2 + vK[x] - pointSize/3, canvasHeight/2 - vK[y] - pointSize/3, pointSize, pointSize);
